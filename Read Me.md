'''# Heading 1 (Use more # symbols for smaller subheadings)**Bold Text** and *Italic Text*- Bullet point[Link Text](https://url.com) [1] (https://www.youtube.com/watch?v=yZfGN_78UYo), [2] (https://www.youtube.com/watch?v=ZnXaCBPT9IM)'''

16-09-26 Time: 23:55
1.  IST Downloaded faces.tar from [caltech site](https://data.caltech.edu/records/6rjah-hdv18)
2. Also created main.py will follow these three links:
